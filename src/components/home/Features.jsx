  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 rounded-full px-6 py-1.5">
       ...
       <Title title="Build your resume " description="Our streamline process helps you create a professional resume in a minutes with intelligent AI-Powered tools and features "/>
